...
#define throwRuntime(type, text)	((LOG_ERROR("errno: "<<std::strerror(errno)<<" in file: " __FILE__<<" in function: "<<__PRETTY_FUNCTION__<<" line: "<<__LINE__)), (throw type(text)),(void)0)
#define throwInt(text)	((LOG_EXCEPTION(text)), (throw -1),(void)0)
